...
<html lang="en">
	...
	<head>
		...
		<!--begin::Base Path (base relative path for assets-data of this page) -->
		<base href="../">
		...
		<link href="<?php echo base_url(); ?>assets-data/css/demo6/style.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-aside--minimize kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="<?php echo base_url(); ?>login/dashboard">
					<img  id="logo" src="<?php echo base_url(); ?>assets-data/media/logos/home_logo.png" />
				</a>
			</div>
		...
		<div class="kt-grid kt-grid--hor kt-grid--root">
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon2-list-3"></i><span class="kt-menu__link-text">Update Profile</span><span class="kt-menu__link-badge"><span class="kt-badge kt-badge--brand">E</span></span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item " aria-haspopup="true"><a  href="login/update_employee_profile/<?php echo $dashboard_data['email'] ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Update</span></a></li>
           ...
           <!--                                 <li class="kt-menu__item " aria-haspopup="true"><a  href="login/personality_assessment_questions/<?php echo $dashboard_data['email'] ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text"><?php echo $categories[3];?></span></a></li>-->
											<!--<li class="kt-menu__item " aria-haspopup="true"><a  href="login/work_personality_index_form/<?php echo $dashboard_data['email'] ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text"><?php echo $categories[4];?></span></a></li>-->
									...
									<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">Assessments</span><i class="kt-menu__hor-arrow la la-angle-down"></i><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
										<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
											<ul class="kt-menu__subnav">
												...
												<li class="kt-menu__item " aria-haspopup="true"><a  href="login/personality_assessment_questions/<?php echo $dashboard_data['email'] ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text"><?php echo $categories[3];?></span></a></li>
												...
												<!--	</div>-->
												<!--</li>-->
												<!--<li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover" aria-haspopup="true"><a href="login/personality_assessment_questions/<?php echo $dashboard_data['email'] ?>" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text"><?php echo $categories[3];?></span><i class="kt-menu__hor-arrow la la-angle-right"></i><i class="kt-menu__ver-arrow la la-angle-right"></i></a>-->
												<!--	<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">-->
												<!--		<ul class="kt-menu__subnav">-->
						...
						<div class="kt-header__topbar">
							...
							<!-- <div class="kt-header__topbar-item kt-header__topbar-item--langs">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									<span class="kt-header__topbar-icon kt-header__topbar-icon--brand">
										<img class="" src="<?php echo base_url(); ?>assets-data/media/flags/012-uk.svg" alt="" />
									</span>
								</div>
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									...
									<img class="kt-hidden" alt="Pic" src="<?php echo base_url(); ?>assets-data/media/users/300_21.jpg" />
									...
									<div class="kt-notification">
										...
										<a href="#" class="kt-notification__item">
											...
											<div class="kt-notification__item-details">
												...
												<div class="kt-notification__item-time">
													 <!-- <span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill kt-badge--rounded"></span> -->
												</div>
											</div>
										</a>
						...
						<div class="kt-subheader-search ">
							...
							<h3 class="kt-subheader-search__title" style="color:black; font-weight:700px;font-size:30px">
								...
								<h3 class="kt-subheader-search__title">
									Nayatel Employees Assessment Dashboard
									<span class="kt-subheader-search__desc"></span>
								</h3>
							...
							<div class="kt-portlet">
								<div class="kt-portlet__body  kt-portlet__body--fit">
									<div class="row row-no-padding row-col-separator-xl">
									    <?php if(!empty($cultural_scan_record))
											{?>
										...
										<div class="col-md-12 col-lg-6 col-xl-3">
											...
											<div class="kt-widget24">
												<div class="kt-widget24__details">
													<div class="kt-widget24__info">
														<h4 class="kt-widget24__title">
															<a href="login/cultural_scan_questions_view/<?php echo $dashboard_data['email'] ?>" 
    class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
    <span></span></i><span class="kt-menu__link-text"><?php echo $categories[0];?></span></a>
														</h4>
														<span class="kt-widget24__desc">
														
														</span>
													</div>
													<span class="kt-widget24__stats kt-font-brand" style="color:red !important">
														Pending
													</span>
												</div>
												<div class="progress progress--sm">
									...
									<!--if-->
										...
										<div class="col-md-12 col-lg-6 col-xl-3">
											...
											<div class="kt-widget24">
												...
												<div class="progress progress--sm">
													<div class="progress-bar kt-bg-warning" role="progressbar" style="width: 100%; background-color: #1dc9b7 !important" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
												</div>
												<div class="kt-widget24__action">
													<span class="kt-widget24__change">
										...
										<div class="col-md-12 col-lg-6 col-xl-3">
											...
											<div class="kt-widget24">
												<div class="kt-widget24__details">
													<div class="kt-widget24__info">
														<h4 class="kt-widget24__title">
														 <a  href="login/personal_values_assessment/<?php echo $dashboard_data['email'] ?>" 
    class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
    <span class="kt-menu__link-text"><?php echo $categories[2];?></span></a>
														</h4>
														<span class="kt-widget24__desc">
															
														</span>
													</div>
													<span class="kt-widget24__stats kt-font-danger" style="color:red !important">
														Pending
													</span>
												</div>
												<div class="progress progress--sm">
										...
										<!--if-->
										<?php if(!empty($personality_record))
											{?>
										<div class="col-md-12 col-lg-6 col-xl-3">
										...
										<div class="col-md-12 col-lg-6 col-xl-3">
											...
											<div class="kt-widget24">
												<div class="kt-widget24__details">
													<div class="kt-widget24__info">
														<h4 class="kt-widget24__title">
														<a  href="login/personality_assessment_questions/<?php echo $dashboard_data['email'] ?>" 
    class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span>
    </i><span class="kt-menu__link-text"><?php echo $categories[3];?></span>
</span></a>
														</h4>
														<span class="kt-widget24__desc">
...
<?php }?>
						...
						<!--<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">-->
							...
							<!--							<img src="<?php echo base_url(); ?>assets-data/media/files/doc.svg" alt="">-->
							<!--						</div>-->
							...
							<!--					<div class="kt-widget4__item">-->
							<!--						<div class="kt-widget4__pic kt-widget4__pic--icon">-->
							<!--							<img src="<?php echo base_url(); ?>assets-data/media/files/jpg.svg" alt="">-->
							<!--						</div>-->
							<!--						<a href="#" class="kt-widget4__title">-->
							...
							<!--					<div class="kt-widget4__item">-->
							<!--						<div class="kt-widget4__pic kt-widget4__pic--icon">-->
							<!--							<img src="<?php echo base_url(); ?>assets-data/media/files/pdf.svg" alt="">-->
							<!--						</div>-->
							<!--						<a href="#" class="kt-widget4__title">-->
							...
							<!--					<div class="kt-widget4__item">-->
							<!--						<div class="kt-widget4__pic kt-widget4__pic--icon">-->
							<!--							<img src="<?php echo base_url(); ?>assets-data/media/files/javascript.svg" alt="">-->
							<!--						</div>-->
							<!--						<a href="#" class="kt-widget4__title">-->
							<!--							Make JS Great Again-->
							<!--						</a>-->
							...
							<!--					<div class="kt-widget4__item">-->
							<!--						<div class="kt-widget4__pic kt-widget4__pic--icon">-->
							<!--							<img src="<?php echo base_url(); ?>assets-data/media/files/zip.svg" alt="">-->
							<!--						</div>-->
							<!--						<a href="#" class="kt-widget4__title">-->
		...
		<script src="<?php echo base_url(); ?>assets-data/js/demo6/scripts.bundle.js" type="text/javascript"></script>
