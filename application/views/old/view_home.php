	...
	<section id="about" class="container">
		...
		<div class="inner about">
			...
			<div class="about-boxes clearfix t-center">
				...
				<!-- About Box -->
				<div class="col-xs-6 about-box animated text-center" data-animation="fadeIn" data-animation-delay="300">
	...
	<section id="contact" class="container">
		...
		<div class="">
			...
			<div class="contact animated" data-animation="fadeIn" data-animation-delay="200">
				<!-- Contact Form -->
				<form id="contact-form" name="cform" class="clearfix" method="post" action="php/mail.php">
					<!-- Left Inputs -->
			...
			<?php
		      ...
		      ?>  
				<div class="col-xs-3 text-center">
					...
					<a href="<?php echo base_url() ; ?>news/<?php echo $news['news_id']; ?>"><h3><?php echo $news['news_title']; ?></h3>
