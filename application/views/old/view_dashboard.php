			...
			<div class="col-md-4">
			    ...
			    <div class="col-md-8">
			    	...
			    	<?php
			    		...
			    		$checkorder = $this->db->get_where('tbl_order',array('chef_id' => $this->session->userdata('id')));
			    		if($checkorder->num_rows() > 0){
			    			foreach($checkorder->result() as $ord){
			    				$getseller = $this->db->get_where('tbl_customer',array('customer_id' => $ord->customer_id))->row();
