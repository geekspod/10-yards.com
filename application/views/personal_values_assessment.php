...
<?php echo form_open_multipart(base_url().'login/personal_values_assessment_questions_data',array('class' => 'form-horizontal')); ?>
    ...
    margin: 0 auto">
          ...
          <table id="checkboxes" class="table table-bordered table-striped">
            ...
            <tbody>
            	<?php
                $i=0;
                if (!empty($personal_values_assessment)){
            	foreach ($personal_values_assessment as $row) {
            		$i++;
            		?>
					<tr>
	                    <td><?php echo $i; ?></td>
