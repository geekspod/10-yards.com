				...
				<div class="row">
					<div class="col-md-2">
						 <label class="container">Yes
						  <input type="radio" name="notification" value="0" <?php if($userdata->emailnotify == 0){ echo 'checked';} ?>>
					...
					<div class="col-md-2">
						<label class="container">No
						  <input type="radio" name="notification" value="1" <?php if($userdata->emailnotify == 1){ echo 'checked';} ?>>
						  <span class="checkmark"></span>
						</label>
					</div>
				</div>
...
<script type="text/javascript">
	jQuery('.updatebtn').click(function() {
		...
		jQuery.ajax({
			url  	: '<?php echo base_url() ; ?>profile/updateemailnotification',
			data 	: form,
			type 	: 'POST',
			dataType : 'Json',
