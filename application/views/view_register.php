    ...
    font-weight: bold; margin-top:50px">Create Your Account</h3>
				...
				<form id="second_form" method="post" action="<?php echo base_url();?>register/save">
				<div class="sgn-form">
				...
				<input type="hidden" class="role_id" name="role_id" value="<?php echo $this->uri->segment(3) ; ?>">
						...
						<label class="col-sm-2 control-label" style="width:51%;margin-bottom: 20px">No Of Functional Departments*</label>
								...
								<select class="form-control m-b" name="department" id="department" onchange='checkvalue(this.value)'>
							<?php	    if(!empty($department_data)){
								...
								<option value="Request New Department" <?php { echo "Selected";} ?> >Request New Department</option>
								</select>
								<input type="text" name="department" id="color" class="form-control"/>
						...
						<?php echo "<br>";?>
							...
							<label class="col-sm-2 control-label" style="width:51%;margin-bottom: 20px">Job Title*</label>
								<div class="col-sm-4" style=";margin-bottom: 20px;width:49%;padding: 0px">
								<select class="form-control m-b" name="job_title" id="job_title" onchange='check_job_title(this.value)' >
							<?php	    if(!empty($job_title_data)){
								...
								<input type="text" name="job_title" id="color1" class="form-control"/>
							     </div>
				<!--Date picker-->
        <div class="col-md-6">
           <div class="form-group">
...
<!--end-->
					...
					<div class="form-group">
							...
							<input type="text" class="form-control" id="landline" name="landline" aria-describedby="emailHelp" placeholder="Enter landline number: 0511234567" style="width:97%">
   ...
   <option value="Zimbabwe">Zimbabwe</option>
							...
							<!--select location-->
							 <label class="col-sm-2 control-label" style="width:51%;margin-bottom: 20px">Select Location*</label>
								<div class="col-sm-4" style=";margin-bottom: 20px;width:49%;padding: 0px">
								<select class="form-control m-b" name="location" id="location" onchange='check_location(this.value)'>
								...
								<input type="text" name="location" id="color2" class="form-control"/>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="mobile" name="mobile" aria-describedby="emailHelp" placeholder="Enter mobile number:3451234567" style="width:97%">
							<span id="message"> </span>
						</div>
						
						<div class="form-group">
							<label  class="fn">Cnic*</label>
							<input type="text" class="form-control" id="cnic" name="cnic" aria-describedby="emailHelp" placeholder="Enter CNIC in correct format. 12345-1234567-1" style="width:97%">
				...
				<label class="col-sm-2 control-label" style="width:51%;margin-bottom: 20px">Select Gender*</label>
								...
								<input type="text" name="gender" id="color3" class="form-control"/>
							...
							<label class="col-sm-2 control-label" style="width:51%;margin-bottom: 20px">Reporting To*</label>
								<div class="col-sm-4" style=";margin-bottom: 20px;width:49%;padding: 0px">
								<select class="form-control m-b" name="reporting" id="reporting" onchange='check_reporting(this.value)'>
							<?php	    if(!empty($reporting_data)){
								...
								<input type="text" name="reporting" id="color4" class="form-control"/>
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id="password" name="password" placeholder="Password" style="width:97%" passwordCheck="passwordCheck" />
							<span id="pass"> </span>
  ...
  submitHandler: function(form) {
   $.ajax({
            ...
            success: function(response) {
               alert('success');// $('#answers').html(response);
