		...
		<section class="sing-in-banner container" style="    background: #333;
    color: white;
    ...
    font-weight: bolder; 
    padding-top: 50px">Forget Password</h3>
				</div>
				<div class="sgn-form">
					<?php
					...
					<form action="<?php echo base_url().'forget-password' ; ?>" class="loginform" id="loginresult">
						...
						<div class="form-check" style="font-size:20px; padding-bottom:12px">
							<span class="rem">
