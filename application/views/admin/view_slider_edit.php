					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							    ...
							    <textarea id="textarea" type="text" class="form-control" name="heading" placeholder="Kindly enter heading name."><?php echo $slider['heading']; ?></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea class="form-control" id="textarea" name="content" style="height:140px;"><?php echo $slider['content']; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Youtube Video URL </label>
							<div class="col-sm-6">
							    <textarea id="textarea" type="text" class="form-control" name="button1_text" placeholder="Kindly enter youtube video URL"><?php echo $slider['button1_text']; ?></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" onclick="spell_btn()" class="btn btn-success pull-left" name="form1">Submit</button>
							</div>
						</div>
					</div>
				</div>
