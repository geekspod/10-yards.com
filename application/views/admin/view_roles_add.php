...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'admin/roles/add',array('class' => 'form-horizontal')); ?>
		...
		<!--<div class="content-header-right">-->
		<!--<a href="<?php echo base_url(); ?>" class="btn btn-primary btn-sm">View User History</a>-->
	 <!--   </div>-->
