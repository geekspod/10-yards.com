                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <?php echo form_close(); ?>
<!--WHO WE ARE-->
                            <h3 class="sec_title"><?php echo $why_home['name']; ?></h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_welcome_title" class="form-control" value="<?php echo $why_home['name']; ?>">
                                    </div>
                                </div>
			...
			<label class="col-sm-2 control-label">Text*</label>
              <div class="col-sm-10">
              	<textarea class="ckeditor" placeholder="Enter Html Body" name="home_welcome_text" id="home_welcome_text"><?php echo $why_home['content']; ?>
                        ...
                        <h3 class="sec_title"><?php echo $our_vision['name']; ?></h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="our_vision_name" class="form-control" value="<?php echo $our_vision['name']; ?>"/>
                                    </div>
                                </div>
    ...
    <div class="form-group">
			<label class="col-sm-2 control-label">Text*</label>
            <div class="col-sm-10">
            <textarea class="ckeditor" placeholder="Enter Html Body" name="our_vision_content" id="our_vision_content" value="<?php echo $our_vision['content']; ?>"><?php echo $our_vision['content']; ?>
            </textarea>
             </div>
             </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Show on Home? </label>
                                    <div class="col-sm-2">
                                        <select name="why_us_status" class="form-control select2" style="width:auto;">
                                        <option value="Show" <?php if($page_home['home_welcome_status'] == 'Show') {echo 'selected';} ?>>Show</option>
                                        <option value="Hide" <?php if($page_home['home_welcome_status'] == 'Hide') {echo 'selected';} ?>>Hide</option>
                                    </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="our_vision">Update</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
...
<!--Why Us-->
                    <h3 class="sec_title"><?php echo $why_us['name']; ?></h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="why_us_name" class="form-control" value="<?php echo $why_us['name']; ?>"/>
                                    </div>
                                </div>
    ...
    <div class="form-group">
			<label class="col-sm-2 control-label">Text*</label>
            <div class="col-sm-10">
            <textarea class="ckeditor" placeholder="Enter Html Body" name="why_us_content" id="why_us_content" value="<?php echo $why_us['content']; ?>"><?php echo $why_us['content']; ?>
            </textarea>
             </div>
             </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="why_us">Update</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
...
<!--4-OUR-HISTORY-->
                            ...
                            <h3 class="sec_title"><?php echo $qhr_numbers['name']; ?></h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="qhr_numbers_name" class="form-control" value="<?php echo $qhr_numbers['name']; ?>"/>
                                    </div>
                                </div>
			...
			<label class="col-sm-2 control-label">Text*</label>
            <div class="col-sm-10">
            <textarea class="ckeditor" placeholder="Enter Html Body" name="qhr_numbers_content" id="qhr_numbers_content"><?php echo $qhr_numbers['content']; ?>
            </textarea>
             </div>
             </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Show on Home? </label>
                                    <div class="col-sm-2">
                                        <select name="qhr_numbers_status" class="form-control select2" style="width:auto;">
                                        <option value="Show" <?php if($page_home['home_welcome_status'] == 'Show') {echo 'selected';} ?>>Show</option>
                                        <option value="Hide" <?php if($page_home['home_welcome_status'] == 'Hide') {echo 'selected';} ?>>Hide</option>
                                    </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="qhr_numbers">Update</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
