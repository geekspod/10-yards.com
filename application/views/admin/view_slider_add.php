				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							    <textarea id="textarea" type="text" class="form-control" name="heading" placeholder="Kindly enter heading name"></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							     <textarea id="textarea" type="text" class="form-control" name="content" placeholder="Kindly enter heading name"></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							    <textarea id="textarea" type="text" class="form-control" name="button1_text" placeholder="Kindly enter heading name"></textarea>
