				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-6">
							    <textarea id="textarea" type="text" class="form-control" name="name" placeholder="Kindly enter name."></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							     <textarea id="textarea" type="text" class="form-control" name="designation" placeholder="Kindly enter name."></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea id="textarea" type="text" class="ckeditor" name="comment" placeholder="Kindly enter comment." style="height:200px;"></textarea>
							</div>
						</div>
						<div class="form-group">
