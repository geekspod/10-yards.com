...
class Forget_password extends CI_Controller 
{
    ...
    {
        parent::__construct();
        $this->load->model('Model_forget_password');
    }
    ...
    public function index()
    {
        ...
        if(isset($_POST['form1'])) {
            ...
            if($valid == 1) {
                ...
                // Send Email
                $msg = '<p>To reset your password, please <a href="'.base_url().'reset-password/index/'.$_POST['email'].'/'.$token.'">click here</a> and enter a new password';
                $config = array();
