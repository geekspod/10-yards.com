	...
	public function update()
	{
		...
		if(isset($_POST['form_home_counter_text'])) {
        	$form_data = array(
				...
				'counter_1_value' => $_POST['counter_2_value'],
				'counter_3_title' => $_POST['counter_3_title'],
				'counter_1_value' => $_POST['counter_3_value'],
				'counter_4_title' => $_POST['counter_4_title'],
				'counter_1_value' => $_POST['counter_4_value'],
		...
		if(isset($_POST['form_home_blog'])) {
        	...
        	$this->Model_page->update_home($form_data);
        	$success = 'Home page news information is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_faq'])) {
        	...
        	$success = 'Investment Page Setting is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_service'])) {
        	$form_data = array(
				...
				'service_subheading' => $_POST['service_subheading'],
        	...
        	$success = 'Refferal Page Setting is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
